...
export function MonacoEditorWrapper({ onMount , projectId , fileId}) {
  ...
  <button className="flex items-center gap-2 px-4 py-1.5 text-blue-400 rounded-md transition duration-200 hover:bg-blue-500 hover:text-white">
    <Play size={16} />
    Run
  </button>
  <button onClick={handleSubmit} className="flex items-center gap-2 px-4 py-1.5 text-white rounded-md transition duration-200 hover:bg-gray-700">
    <Upload size={16} />
    Submit
  </button>
</div>
